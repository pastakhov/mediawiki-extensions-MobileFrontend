...
class MobileFormatter extends HtmlFormatter {
	...
	public function filterContent(
		...
		if ( !$this->mainPage && $this->expandableSections ) {
			...
			$this->makeSections( $doc, $headings, $transformOptions, $container, $sectionNumber, $sections );
			if ( $sections ) {
				$this->makeSectionsForSubheadings( $doc, $sections, $transformOptions, $sectionNumber );
			}
		} else {
	 ...
	 */
	protected function makeSections( DOMDocument $doc, array $headings, array $transformOptions, DOMNode $container, int &$sectionNumber, array &$sections ) {
	 ...
	 */
	private function getHeadings( DOMNode $doc ) {
